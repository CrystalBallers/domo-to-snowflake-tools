-- ERROR: Could not retrieve columns for table DW_REPORTS.raw_domo.DAILY_BB_CAPTURE_ASIN_DV using role: DBT_ROLE
-- 
-- This file could not be generated because the table schema could not be retrieved.
-- 
-- Possible causes:
-- 1. Table DW_REPORTS.raw_domo.DAILY_BB_CAPTURE_ASIN_DV does not exist
...
/*
TABLE: DW_REPORTS.raw_domo.DAILY_BB_CAPTURE_ASIN_DV
...
/*
with
    source as (select * from {{ source("raw_domo", "DAILY_BB_CAPTURE_ASIN_DV") }})
