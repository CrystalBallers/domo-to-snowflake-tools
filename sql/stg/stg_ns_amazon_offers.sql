-- ERROR: Could not retrieve columns for table DW_REPORTS.raw_domo.NS_AMAZON_OFFERS using role: DBT_ROLE
-- 
-- This file could not be generated because the table schema could not be retrieved.
-- 
-- Possible causes:
-- 1. Table DW_REPORTS.raw_domo.NS_AMAZON_OFFERS does not exist
...
/*
TABLE: DW_REPORTS.raw_domo.NS_AMAZON_OFFERS
DATASET_ID: 4fd35fe7-8a89-4e45-8dac-a2a125ac86f1
ROLE_USED: DBT_ROLE
...
/*
with
    source as (select * from {{ source("raw_domo", "NS_AMAZON_OFFERS") }})
