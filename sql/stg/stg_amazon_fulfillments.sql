-- ERROR: Could not retrieve columns for table DW_REPORTS.raw_domo.AMAZON_FULFILLMENTS using role: DBT_ROLE
-- 
-- This file could not be generated because the table schema could not be retrieved.
-- 
-- Possible causes:
-- 1. Table DW_REPORTS.raw_domo.AMAZON_FULFILLMENTS does not exist
...
/*
TABLE: DW_REPORTS.raw_domo.AMAZON_FULFILLMENTS
DATASET_ID: b4102073-2a76-411f-a48c-9bb6b653fbe4
ROLE_USED: DBT_ROLE
...
/*
with
    source as (select * from {{ source("raw_domo", "AMAZON_FULFILLMENTS") }})
