-- ERROR: Could not retrieve columns for table DW_REPORTS.raw_domo.PCN_OFFERS_LATEST using role: DBT_ROLE
-- 
-- This file could not be generated because the table schema could not be retrieved.
-- 
-- Possible causes:
-- 1. Table DW_REPORTS.raw_domo.PCN_OFFERS_LATEST does not exist
...
/*
TABLE: DW_REPORTS.raw_domo.PCN_OFFERS_LATEST
DATASET_ID: 485010df-a770-43fa-a146-db6ba67e84b4
ROLE_USED: DBT_ROLE
...
/*
with
    source as (select * from {{ source("raw_domo", "PCN_OFFERS_LATEST") }})
