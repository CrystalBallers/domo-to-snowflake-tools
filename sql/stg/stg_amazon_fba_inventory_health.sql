-- ERROR: Could not retrieve columns for table DW_REPORTS.raw_domo.AMAZON_FBA_INVENTORY_HEALTH using role: DBT_ROLE
-- 
-- This file could not be generated because the table schema could not be retrieved.
-- 
-- Possible causes:
-- 1. Table DW_REPORTS.raw_domo.AMAZON_FBA_INVENTORY_HEALTH does not exist
...
/*
TABLE: DW_REPORTS.raw_domo.AMAZON_FBA_INVENTORY_HEALTH
DATASET_ID: 6d428ba4-6501-4d1b-b483-8a9ecf6caba4
ROLE_USED: DBT_ROLE
GENERATED_AT: 2025-07-31 23:02:24
STATUS: FAILED
*/
...
/*
with
    source as (select * from {{ source("raw_domo", "AMAZON_FBA_INVENTORY_HEALTH") }})
