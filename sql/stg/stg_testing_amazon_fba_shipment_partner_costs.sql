-- ERROR: Could not retrieve columns for table DW_REPORTS.TEMP_ARGO_RAW.TESTING]_AMAZON_FBA_SHIPMENT_PARTNER_COSTS using role: DBT_ROLE
-- 
-- This file could not be generated because the table schema could not be retrieved.
-- 
-- Possible causes:
-- 1. Table DW_REPORTS.TEMP_ARGO_RAW.TESTING]_AMAZON_FBA_SHIPMENT_PARTNER_COSTS does not exist
...
/*
TABLE: DW_REPORTS.TEMP_ARGO_RAW.TESTING]_AMAZON_FBA_SHIPMENT_PARTNER_COSTS
DATASET_ID: 3bff8271-4286-4182-9fb8-12d2163c0752
ROLE_USED: DBT_ROLE
GENERATED_AT: 2025-07-31 23:25:37
STATUS: FAILED
*/
...
/*
with
    source as (select * from {{ source("TEMP_ARGO_RAW", "TESTING]_AMAZON_FBA_SHIPMENT_PARTNER_COSTS") }})
